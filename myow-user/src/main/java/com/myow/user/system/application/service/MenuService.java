...
import com.myow.user.system.application.converter.MenuApplicationConverter;
...
import com.myow.user.system.infrastructure.converter.MenuConverter;
...
public class MenuService {
    ...
    public void deleteMenu(Long id) {
        ...
        Long roleCount = roleMenuRepository.count(Wrappers.lambdaQuery(com.myow.user.system.infrastructure.persistence.po.RoleMenuDO.class)
                .eq(com.myow.user.system.infrastructure.persistence.po.RoleMenuDO::getMenuId, id));
        if (roleCount > 0) {
