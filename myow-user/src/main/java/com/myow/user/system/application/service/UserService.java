...
import com.myow.user.system.application.converter.UserApplicationConverter;
import com.myow.user.system.application.dto.*;
...
public class UserService {
    ...
    public String createTenantAdminUser(String tenantId, CreateUserDTO createUserDTO) {
        ...
        // 设置密码
        String generateSaltPassword = PasswordService.generateSaltPassword(PasswordService.randomPassword(), userCode);
        userDO.setPassword(PasswordService.getEncryptPwd(generateSaltPassword));
        // 保存
