...
import com.myow.user.system.application.converter.PositionApplicationConverter;
...
import com.myow.user.system.infrastructure.converter.PositionConverter;
...
public class PositionService {
    ...
    public List<PositionRespDTO> getPositionListByIds(List<Long> positionIdList) {
        List<PositionDO> positionDOList = positionRepository.listByIds(positionIdList);
        return positionApplicationConverter.convert(positionDOList);
    }
}
