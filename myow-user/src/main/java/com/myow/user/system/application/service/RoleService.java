...
import com.myow.user.system.application.converter.RoleApplicationConverter;
...
import com.myow.user.system.infrastructure.converter.RoleConverter;
...
import com.myow.user.system.infrastructure.persistence.repository.UserRoleRepository;
...
public class RoleService {
    ...
    public void deleteRole(Long id) {
        ...
        Long userCount = userRoleRepository.count(Wrappers.lambdaQuery(com.myow.user.system.infrastructure.persistence.po.UserRoleDO.class)
                .eq(com.myow.user.system.infrastructure.persistence.po.UserRoleDO::getRoleId, id));
        if (userCount > 0) {
