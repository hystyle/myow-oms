...
import com.myow.user.system.application.converter.DictApplicationConverter;
...
import com.myow.user.system.infrastructure.converter.DictConverter;
...
public class DictService {
    ...
    public Long createDict(CreateDictReqDTO createReqDTO) {
        ...
        DictDO dictDO = dictConverter.toDo(dict);
